...
import es.jlcm.IntegrationTest;
import es.jlcm.config.Constants;
import es.jlcm.domain.User;
import es.jlcm.repository.AuthorityRepository;
...
import es.jlcm.service.dto.PasswordChangeDTO;
import es.jlcm.web.rest.vm.KeyAndPasswordVM;
import es.jlcm.web.rest.vm.ManagedUserVM;
